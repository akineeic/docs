...
# ============================================================================
"""Densenet121 model train with MindSpore"""
import os
import argparse
import random
import time
...
def densenet121_train(args_opt):
    epoch_size = args_opt.epoch_size
    batch_size = 64
    class_num = 10
    loss_scale_num = 1024
    local_data_path = '/cache/data'
    ckpt_path = 's3://densenet-train-zzm/output/'
    ...
    loss_cb = LossMonitor()
    config_ck = CheckpointConfig(save_checkpoint_steps=10, keep_checkpoint_max=20)
    ckpoint_cb = ModelCheckpoint(prefix='densenet', directory=ckpt_path, config=config_ck)
    cb = [performance_cb, loss_cb, ckpoint_cb]
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Densenet121 train.')
    ...
    densenet121_train(args_opt)
    print('Densenet121 training success!')
